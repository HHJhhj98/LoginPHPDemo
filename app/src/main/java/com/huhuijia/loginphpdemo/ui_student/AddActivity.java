...
public class AddActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            if (msg.what == Constants.SUCCESS) {
                Toast.makeText(AddActivity.this, (String) msg.obj, Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private void initView() {
        ...
        snoET = (EditText) findViewById(R.id.snoET);
        snoET.setText(sno);
        snoET.setFocusable(false);
    }

    private void add() {

        // validate
        final String subjectETString = mSubjectET.getText().toString().trim();
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    String path = "http://119.29.94.69/android/add.php";
